...
# parser.add_argument("--run_simulations", type=bool, help="1 if run simulation", default="0")
#
...
comparison_folder = "../results_plots/paper_3_1_linearly_spaced_mu"
n_exps = 50

# Run Bubeck only for M=2, K=3
algo_to_plot = ["Bubeck-Budzinski"]
...
M5_dict_K_T = {6:2000000, 10:2000000}
