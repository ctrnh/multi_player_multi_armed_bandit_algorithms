...
#define __PYX_HAVE__cklucb
#define __PYX_HAVE_API__cklucb
/* Early includes */
#include <string.h>
#include <stdio.h>
 ...
 * 
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_6cklucb_DOUBLE;
 ...
 * np.import_array()
 */
typedef __pyx_t_5numpy_int32_t __pyx_t_6cklucb_INT;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'cklucb' */
static CYTHON_INLINE double __pyx_f_6cklucb_double_max(double, double); /*proto*/
static CYTHON_INLINE double __pyx_f_6cklucb_double_min(double, double); /*proto*/
static double __pyx_f_6cklucb_klBern(double, double); /*proto*/
static PyArrayObject *__pyx_f_6cklucb_computeKLUCB(int, PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_6cklucb_DOUBLE = { "DOUBLE", NULL, sizeof(__pyx_t_6cklucb_DOUBLE), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_6cklucb_INT = { "INT", NULL, sizeof(__pyx_t_6cklucb_INT), { 0 }, 0, IS_UNSIGNED(__pyx_t_6cklucb_INT) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_6cklucb_INT), 0 };
#define __Pyx_MODULE_NAME "cklucb"
extern int __pyx_module_is_main_cklucb;
int __pyx_module_is_main_cklucb = 0;

/* Implementation of 'cklucb' */
...
static const char __pyx_k_pulls[] = "pulls";
static const char __pyx_k_range[] = "range";
static const char __pyx_k_zeros[] = "zeros";
static const char __pyx_k_import[] = "__import__";
static const char __pyx_k_mu_hat[] = "mu_hat";
...
static PyObject *__pyx_n_s_mu_hat;
...
static PyObject *__pyx_n_s_pulls;
...
static PyObject *__pyx_pf_6cklucb_computeKLUCB(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_t, PyArrayObject *__pyx_v_mu_hat, PyArrayObject *__pyx_v_pulls); /* proto */
...
static CYTHON_INLINE double __pyx_f_6cklucb_double_max(double __pyx_v_a, double __pyx_v_b) {
  double __pyx_r;
...
static CYTHON_INLINE double __pyx_f_6cklucb_double_min(double __pyx_v_a, double __pyx_v_b) {
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
...
static double __pyx_f_6cklucb_klBern(double __pyx_v_x, double __pyx_v_y) {
 ...
 */
  __pyx_v_x = __pyx_f_6cklucb_double_min(__pyx_f_6cklucb_double_max(__pyx_v_x, 1e-7), (1.0 - 1e-7));
 ...
 * 
 */
  __pyx_v_y = __pyx_f_6cklucb_double_min(__pyx_f_6cklucb_double_max(__pyx_v_y, 1e-7), (1.0 - 1e-7));
 ...
 */
  ...
  __pyx_r = ((__pyx_v_x * log((__pyx_v_x / __pyx_v_y))) + ((1.0 - __pyx_v_x) * log((__pyx_t_1 / __pyx_t_2))));
  goto __pyx_L0;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("cklucb.klBern", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyObject *__pyx_pw_6cklucb_1computeKLUCB(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyArrayObject *__pyx_f_6cklucb_computeKLUCB(int __pyx_v_t, PyArrayObject *__pyx_v_mu_hat, PyArrayObject *__pyx_v_pulls, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_player;
  Py_ssize_t __pyx_v_arm;
  double __pyx_v_eps;
  ...
  PyArrayObject *__pyx_v_ucb_idx = 0;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_mu_hat;
  __Pyx_Buffer __pyx_pybuffer_mu_hat;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_pulls;
  __Pyx_Buffer __pyx_pybuffer_pulls;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_ucb_idx;
  __Pyx_Buffer __pyx_pybuffer_ucb_idx;
  ...
  __Pyx_RefNannySetupContext("computeKLUCB", 0);
  __pyx_pybuffer_ucb_idx.pybuffer.buf = NULL;
  __pyx_pybuffer_ucb_idx.refcount = 0;
  __pyx_pybuffernd_ucb_idx.data = NULL;
  __pyx_pybuffernd_ucb_idx.rcbuffer = &__pyx_pybuffer_ucb_idx;
  __pyx_pybuffer_mu_hat.pybuffer.buf = NULL;
  __pyx_pybuffer_mu_hat.refcount = 0;
  __pyx_pybuffernd_mu_hat.data = NULL;
  __pyx_pybuffernd_mu_hat.rcbuffer = &__pyx_pybuffer_mu_hat;
  __pyx_pybuffer_pulls.pybuffer.buf = NULL;
  __pyx_pybuffer_pulls.refcount = 0;
  __pyx_pybuffernd_pulls.data = NULL;
  __pyx_pybuffernd_pulls.rcbuffer = &__pyx_pybuffer_pulls;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_mu_hat.rcbuffer->pybuffer, (PyObject*)__pyx_v_mu_hat, &__Pyx_TypeInfo_nn___pyx_t_6cklucb_DOUBLE, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 25, __pyx_L1_error)
  }
  __pyx_pybuffernd_mu_hat.diminfo[0].strides = __pyx_pybuffernd_mu_hat.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_mu_hat.diminfo[0].shape = __pyx_pybuffernd_mu_hat.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_mu_hat.diminfo[1].strides = __pyx_pybuffernd_mu_hat.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_mu_hat.diminfo[1].shape = __pyx_pybuffernd_mu_hat.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_pulls.rcbuffer->pybuffer, (PyObject*)__pyx_v_pulls, &__Pyx_TypeInfo_nn___pyx_t_6cklucb_INT, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 25, __pyx_L1_error)
  }
  __pyx_pybuffernd_pulls.diminfo[0].strides = __pyx_pybuffernd_pulls.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_pulls.diminfo[0].shape = __pyx_pybuffernd_pulls.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_pulls.diminfo[1].strides = __pyx_pybuffernd_pulls.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_pulls.diminfo[1].shape = __pyx_pybuffernd_pulls.rcbuffer->pybuffer.shape[1];
 ...
 */
  __pyx_v_M = (__pyx_v_mu_hat->dimensions[0]);
 ...
 */
  __pyx_v_K = (__pyx_v_mu_hat->dimensions[1]);
 ...
 */
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_M); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_float64); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 43, __pyx_L1_error)
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_ucb_idx.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_6cklucb_DOUBLE, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
      __pyx_v_ucb_idx = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_ucb_idx.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 42, __pyx_L1_error)
    } else {__pyx_pybuffernd_ucb_idx.diminfo[0].strides = __pyx_pybuffernd_ucb_idx.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_ucb_idx.diminfo[0].shape = __pyx_pybuffernd_ucb_idx.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_ucb_idx.diminfo[1].strides = __pyx_pybuffernd_ucb_idx.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_ucb_idx.diminfo[1].shape = __pyx_pybuffernd_ucb_idx.rcbuffer->pybuffer.shape[1];
    }
  }
  __pyx_t_6 = 0;
  __pyx_v_ucb_idx = ((PyArrayObject *)__pyx_t_5);
  __pyx_t_5 = 0;
 ...
 *             u = 1
 */
      __pyx_t_13 = (log(__pyx_v_t) + (3.0 * log(log(__pyx_v_t))));
      __pyx_t_14 = __pyx_v_player;
      __pyx_t_15 = __pyx_v_arm;
      __pyx_t_16 = -1;
      if (__pyx_t_14 < 0) {
        __pyx_t_14 += __pyx_pybuffernd_pulls.diminfo[0].shape;
        if (unlikely(__pyx_t_14 < 0)) __pyx_t_16 = 0;
      } else if (unlikely(__pyx_t_14 >= __pyx_pybuffernd_pulls.diminfo[0].shape)) __pyx_t_16 = 0;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_pybuffernd_pulls.diminfo[1].shape;
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_16 = 1;
      } else if (unlikely(__pyx_t_15 >= __pyx_pybuffernd_pulls.diminfo[1].shape)) __pyx_t_16 = 1;
      if (unlikely(__pyx_t_16 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_16);
        __PYX_ERR(0, 47, __pyx_L1_error)
      }
      __pyx_t_17 = (__pyx_v_eps + (*__Pyx_BufPtrStrided2d(__pyx_t_6cklucb_INT *, __pyx_pybuffernd_pulls.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_pulls.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_pulls.diminfo[1].strides)));
      if (unlikely(__pyx_t_17 == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
        __PYX_ERR(0, 47, __pyx_L1_error)
      }
      __pyx_v_d = (__pyx_t_13 / __pyx_t_17);
 ...
 */
      __pyx_t_18 = __pyx_v_player;
      __pyx_t_19 = __pyx_v_arm;
      __pyx_t_16 = -1;
      if (__pyx_t_18 < 0) {
        __pyx_t_18 += __pyx_pybuffernd_mu_hat.diminfo[0].shape;
        if (unlikely(__pyx_t_18 < 0)) __pyx_t_16 = 0;
      } else if (unlikely(__pyx_t_18 >= __pyx_pybuffernd_mu_hat.diminfo[0].shape)) __pyx_t_16 = 0;
      if (__pyx_t_19 < 0) {
        __pyx_t_19 += __pyx_pybuffernd_mu_hat.diminfo[1].shape;
        if (unlikely(__pyx_t_19 < 0)) __pyx_t_16 = 1;
      } else if (unlikely(__pyx_t_19 >= __pyx_pybuffernd_mu_hat.diminfo[1].shape)) __pyx_t_16 = 1;
      if (unlikely(__pyx_t_16 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_16);
        __PYX_ERR(0, 50, __pyx_L1_error)
      }
      __pyx_v_l = (*__Pyx_BufPtrStrided2d(__pyx_t_6cklucb_DOUBLE *, __pyx_pybuffernd_mu_hat.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_mu_hat.diminfo[0].strides, __pyx_t_19, __pyx_pybuffernd_mu_hat.diminfo[1].strides));
 ...
 */
      while (1) {
        __pyx_t_21 = (((__pyx_v_u - __pyx_v_l) > __pyx_v_precision) != 0);
        if (__pyx_t_21) {
        } else {
          __pyx_t_20 = __pyx_t_21;
          goto __pyx_L9_bool_binop_done;
        }
        __pyx_t_21 = ((__pyx_v_count <= 50) != 0);
        __pyx_t_20 = __pyx_t_21;
 ...
 *                     u = m
 */
        __pyx_v_m = ((__pyx_v_l + __pyx_v_u) / 2.0);
 ...
 */
        ...
        __pyx_t_23 = __pyx_v_arm;
        __pyx_t_16 = -1;
        if (__pyx_t_22 < 0) {
          __pyx_t_22 += __pyx_pybuffernd_mu_hat.diminfo[0].shape;
          if (unlikely(__pyx_t_22 < 0)) __pyx_t_16 = 0;
        } else if (unlikely(__pyx_t_22 >= __pyx_pybuffernd_mu_hat.diminfo[0].shape)) __pyx_t_16 = 0;
        if (__pyx_t_23 < 0) {
          __pyx_t_23 += __pyx_pybuffernd_mu_hat.diminfo[1].shape;
          if (unlikely(__pyx_t_23 < 0)) __pyx_t_16 = 1;
        } else if (unlikely(__pyx_t_23 >= __pyx_pybuffernd_mu_hat.diminfo[1].shape)) __pyx_t_16 = 1;
        if (unlikely(__pyx_t_16 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_16);
          __PYX_ERR(0, 55, __pyx_L1_error)
        }
        __pyx_t_20 = ((__pyx_f_6cklucb_klBern((*__Pyx_BufPtrStrided2d(__pyx_t_6cklucb_DOUBLE *, __pyx_pybuffernd_mu_hat.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_mu_hat.diminfo[0].strides, __pyx_t_23, __pyx_pybuffernd_mu_hat.diminfo[1].strides)), __pyx_v_m) > __pyx_v_d) != 0);
        if (__pyx_t_20) {
 ...
 */
      ...
      __pyx_t_25 = __pyx_v_arm;
      __pyx_t_16 = -1;
      if (__pyx_t_24 < 0) {
        __pyx_t_24 += __pyx_pybuffernd_ucb_idx.diminfo[0].shape;
        if (unlikely(__pyx_t_24 < 0)) __pyx_t_16 = 0;
      } else if (unlikely(__pyx_t_24 >= __pyx_pybuffernd_ucb_idx.diminfo[0].shape)) __pyx_t_16 = 0;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_pybuffernd_ucb_idx.diminfo[1].shape;
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_16 = 1;
      } else if (unlikely(__pyx_t_25 >= __pyx_pybuffernd_ucb_idx.diminfo[1].shape)) __pyx_t_16 = 1;
      if (unlikely(__pyx_t_16 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_16);
        __PYX_ERR(0, 59, __pyx_L1_error)
      }
      *__Pyx_BufPtrStrided2d(__pyx_t_6cklucb_DOUBLE *, __pyx_pybuffernd_ucb_idx.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_ucb_idx.diminfo[0].strides, __pyx_t_25, __pyx_pybuffernd_ucb_idx.diminfo[1].strides) = ((__pyx_v_l + __pyx_v_u) / 2.0);
    }
  }
 ...
 */
  ...
  __Pyx_INCREF(((PyObject *)__pyx_v_ucb_idx));
  __pyx_r = ((PyArrayObject *)__pyx_v_ucb_idx);
  goto __pyx_L0;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_mu_hat.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_pulls.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_ucb_idx.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("cklucb.computeKLUCB", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_mu_hat.rcbuffer->pybuffer);
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_ucb_idx.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_ucb_idx);
...
/* Python wrapper */
static PyObject *__pyx_pw_6cklucb_1computeKLUCB(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6cklucb_1computeKLUCB(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_t;
  PyArrayObject *__pyx_v_mu_hat = 0;
  PyArrayObject *__pyx_v_pulls = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("computeKLUCB (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_t,&__pyx_n_s_mu_hat,&__pyx_n_s_pulls,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mu_hat)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("computeKLUCB", 1, 3, 3, 1); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pulls)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("computeKLUCB", 1, 3, 3, 2); __PYX_ERR(0, 25, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "computeKLUCB") < 0)) __PYX_ERR(0, 25, __pyx_L3_error)
      }
    ...
    __pyx_v_t = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_t == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
    __pyx_v_mu_hat = ((PyArrayObject *)values[1]);
    __pyx_v_pulls = ((PyArrayObject *)values[2]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("computeKLUCB", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 25, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cklucb.computeKLUCB", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mu_hat), __pyx_ptype_5numpy_ndarray, 1, "mu_hat", 0))) __PYX_ERR(0, 27, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_pulls), __pyx_ptype_5numpy_ndarray, 1, "pulls", 0))) __PYX_ERR(0, 28, __pyx_L1_error)
  __pyx_r = __pyx_pf_6cklucb_computeKLUCB(__pyx_self, __pyx_v_t, __pyx_v_mu_hat, __pyx_v_pulls);
...
static PyObject *__pyx_pf_6cklucb_computeKLUCB(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_t, PyArrayObject *__pyx_v_mu_hat, PyArrayObject *__pyx_v_pulls) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_mu_hat;
  __Pyx_Buffer __pyx_pybuffer_mu_hat;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_pulls;
  __Pyx_Buffer __pyx_pybuffer_pulls;
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_6cklucb_computeKLUCB(__pyx_v_t, __pyx_v_mu_hat, __pyx_v_pulls, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"computeKLUCB", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6cklucb_1computeKLUCB, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cklucb(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cklucb},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_mu_hat, __pyx_k_mu_hat, sizeof(__pyx_k_mu_hat), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_pulls, __pyx_k_pulls, sizeof(__pyx_k_pulls), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcklucb(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcklucb(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cklucb(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cklucb(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cklucb(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cklucb' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cklucb(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cklucb", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cklucb) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cklucb")) {
      if (unlikely(PyDict_SetItemString(modules, "cklucb", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cklucb", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cklucb");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
